  ...
  roles: ["super-admin", "admin", "department-head", "admin-hrmo", "viewer", "admin-ldrrmo"],
            ...
            label: "Debt Services",
            items: [
                { name: "Statement of Indebtedness", href: "/admin/lbp-form5", icon: ScaleIcon, iconBg: "bg-red-100", iconColor: "text-red-600", roles: ["super-admin", "admin", "viewer"] },
            ] as NavItem[],
            },
            {
    label: "Calamity Fund",
...
},
{
    label: "Reports",
    items: [
        { name: "5% CF Reports", href: "/admin/ldrrmf-reports", icon: DocumentTextIcon, iconBg: "bg-violet-100", iconColor: "text-violet-600", roles: ["admin-ldrrmo"] },
    ] as NavItem[],
},
            {
            ...
            items: [
                ...
                { name: "Budget Prop GF & SA", href: "/admin/lbp-forms", icon: ClipboardDocumentListIcon, iconBg: "bg-blue-100", iconColor: "text-blue-600", roles: ["super-admin", "admin", "viewer"] },
            ] as NavItem[],
            },
            {
      label: "Unified Plans",
    ...
    // items: [
    //     { name: "Budget Plans",        href: "/viewer/budget-plans",           icon: DocumentTextIcon,     iconBg: "bg-blue-100",    iconColor: "text-blue-600",   roles: ["viewer"] },
    //     { name: "Summary",             href: "/viewer/summary-expenditures",   icon: ListBulletIcon,       iconBg: "bg-zinc-100",    iconColor: "text-zinc-600",   roles: ["viewer"] },
    //     { name: "Income Fund",         href: "/viewer/income-general-fund",    icon: BanknotesIcon,        iconBg: "bg-emerald-100", iconColor: "text-emerald-600",roles: ["viewer"] },
    //     { name: "Obligations",         href: "/viewer/lbp-form6",              icon: DocumentTextIcon,     iconBg: "bg-teal-100",    iconColor: "text-teal-600",   roles: ["viewer"] },
    //     { name: "Sector Allocation",   href: "/viewer/lbp-form7",              icon: TableCellsIcon,       iconBg: "bg-indigo-100",  iconColor: "text-indigo-600", roles: ["viewer"] },
    //     { name: "Reports",             href: "/viewer/reports-unified",        icon: DocumentChartBarIcon, iconBg: "bg-violet-100",  iconColor: "text-violet-600", roles: ["viewer"] },
    // ] as NavItem[],
    // },
];
        };
        ...
        useNotificationPoller(); // starts polling here since sidebar is always mounted
