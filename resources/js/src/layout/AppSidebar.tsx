  ...
  return (
    <>
      <style>{`
        ...
        .sb-item-1{animation-delay:.03s}.sb-item-2{animation-delay:.07s}.sb-item-3{animation-delay:.11s}
        .sb-item-4{animation-delay:.15s}.sb-item-5{animation-delay:.19s}.sb-item-6{animation-delay:.22s}
        .sb-item-7{animation-delay:.25s}.sb-item-8{animation-delay:.28s}.sb-item-9{animation-delay:.31s}
        .sb-item-10{animation-delay:.34s}.sb-item-11{animation-delay:.37s}.sb-item-12{animation-delay:.40s}
        ...
        <SidebarHeader className="px-3 pt-4 pb-3 border-b border-zinc-100">
          <div key={`hd-${animKey}`} className={cn("flex items-center gap-2.5 group-data-[collapsible=icon]:justify-center", sa(1))}>
            <div className="flex-shrink-0">
              <img src="/images/opol.png" alt="MBO" className="w-5 h-5 object-contain"
