        ...
        <div className="bg-white border border-gray-200 rounded-xl overflow-hidden shadow-sm">
          {loading ? (
            <table className="w-full text-[12px]">
              <thead>
                <tr className="border-b border-gray-200">
                  {["Budget Plan", "Status", "Created", "Last Updated"].map(h => (
                    <th key={h} className="px-4 py-2.5 text-left text-[11px] font-semibold uppercase tracking-wide text-gray-600 bg-white">
                      {h}
                    </th>
                  ))}
                </tr>
            ...
            <div className="text-center py-16 px-4">
              ...
              <p className="text-gray-500 text-sm font-medium mb-1">No budget proposals yet</p>
            ...
            <>
              <table className="w-full text-[12px] border-collapse">
                <thead>
                  <tr>
                    {["Budget Plan", "Status", "Created", "Last Updated"].map(h => (
                      <th key={h} className="border-b border-gray-200 bg-white px-4 py-2.5 text-left font-semibold text-gray-600 text-[11px] uppercase tracking-wide">
                        {h}
                      </th>
                    ))}
                  </tr>
              ...
              <div className="px-4 py-2.5 border-t border-gray-100">
                <p className="text-[10px] text-gray-400 italic">Click a row to view or edit the proposal</p>
              </div>
            </>
          )}
        </div>
