// /**
//  * pages/department-head/BudgetProposal.tsx
//  *
//  * The budget plan list that previously lived in the DepartmentHead Dashboard
//  * is now its own page, accessible from the sidebar under "Budget Proposal".
//  *
//  * Retains all existing create / view / edit behavior.
//  */
...
//   draft:     { label: "Draft",     dot: "bg-amber-400",  badge: "text-amber-700 bg-amber-50 border-amber-200"   },
//   submitted: { label: "Submitted", dot: "bg-blue-400",   badge: "text-blue-700 bg-blue-50 border-blue-200"     },
//   approved:  { label: "Approved",  dot: "bg-emerald-400",badge: "text-emerald-700 bg-emerald-50 border-emerald-200" },
// };
// const getStatusCfg = (s: string) =>
//   statusConfig[s] ?? { label: s, dot: "bg-gray-400", badge: "text-gray-600 bg-gray-50 border-gray-200" };

// // ─── Skeleton row ─────────────────────────────────────────────────────────────

// const RowSkeleton = ({ delay = 0 }: { delay?: number }) => (
//   <tr style={{ opacity: 0, animation: `rowReveal .35s ease forwards`, animationDelay: `${delay}ms` }}>
//     <td className="px-4 py-3"><div className="h-4 w-16 bg-zinc-100 rounded animate-pulse" /></td>
//     <td className="px-4 py-3"><div className="h-5 w-24 bg-zinc-100 rounded-full animate-pulse" /></td>
//     <td className="px-4 py-3"><div className="h-3 w-28 bg-zinc-100 rounded animate-pulse" /></td>
//     <td className="px-2 py-3"><div className="h-6 w-6 bg-zinc-100 rounded animate-pulse ml-auto" /></td>
//   </tr>
// );
...
//               Manage your department's budget plans for each fiscal year
//             </p>
//           </div>
//           <Button
//             size="sm"
...
//                   {["Fiscal Year","Status","Created",""].map((h) => (
//                     <th key={h} className="px-4 py-3 text-left text-[10px] font-semibold uppercase tracking-wide text-zinc-400 bg-zinc-50/60">
//                       {h}
//                     </th>
//                   ))}
//                 </tr>
...
//                 {[0, 70, 140].map((d) => <RowSkeleton key={d} delay={d} />)}
//               </tbody>
//             </table>
//           ) : plans.length === 0 ? (
...
//               </div>
//               <p className="text-zinc-500 text-sm font-medium mb-1">No budget proposals yet</p>
...
//               <thead>
//                 <tr className="border-b border-zinc-100">
//                   <th className="bg-zinc-50/60 px-4 py-3 text-left text-[10px] font-semibold uppercase tracking-wide text-zinc-400 w-36">Fiscal Year</th>
//                   <th className="bg-zinc-50/60 px-4 py-3 text-left text-[10px] font-semibold uppercase tracking-wide text-zinc-400">Status</th>
//                   <th className="bg-zinc-50/60 px-4 py-3 text-left text-[10px] font-semibold uppercase tracking-wide text-zinc-400">Created</th>
...
//           <AlertDialogHeader>
//             <AlertDialogTitle className="text-[15px] font-semibold text-zinc-900">Create budget proposal?</AlertDialogTitle>
...
//               <Button variant="outline" size="sm" className="h-8 text-xs border-zinc-200 rounded-xl">Cancel</Button>
//             </AlertDialogCancel>
//             <AlertDialogAction asChild>
//               <Button size="sm" className="h-8 text-xs bg-zinc-900 hover:bg-zinc-800 rounded-xl" onClick={createPlan}>
//                 Create
//               </Button>
//             </AlertDialogAction>
//           </AlertDialogFooter>
...
//                   <span className="font-medium text-zinc-700">FY {draftPlan.budget_plan?.year}</span>.
//                 </p>
//                 <Link
 ...
 *
 * Retains all existing create / view / edit behavior.
 * NOTE: Draft notification has been moved to the Dashboard.
 */
