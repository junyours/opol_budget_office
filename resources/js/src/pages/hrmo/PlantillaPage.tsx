          ...
          <button
            ...
            className={cn(
              ...
              selectedDeptId === dept.dept_id
                ...
                : '',
              dept.dept_category_id === 1 && (selectedDeptId === dept.dept_id ? 'border-cat-1' : ' border-cat-1 text-cat-1 hover:bg-cat-1/20'),
              dept.dept_category_id === 2 && (selectedDeptId === dept.dept_id ? 'border-cat-2' : ' border-cat-2 text-cat-2 hover:bg-cat-2/20'),
              dept.dept_category_id === 3 && (selectedDeptId === dept.dept_id ? 'border-cat-3' : ' border-cat-3 text-cat-3 hover:bg-cat-3/20'),
              dept.dept_category_id === 4 && (selectedDeptId === dept.dept_id ? 'border-cat-4' : ' border-cat-4 text-cat-4 hover:bg-cat-4/20'),
              !dept.dept_category_id && (selectedDeptId === dept.dept_id ? 'border-gray-900' : ' border-transparent text-gray-500 '),
            )}
          >
